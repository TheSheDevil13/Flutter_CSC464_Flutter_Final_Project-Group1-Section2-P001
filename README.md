...
LinguaAI serves as a smart language tutor that helps learners practice and improve their language skills through natural, interactive conversation. 🗣️ Instead of rigid lessons, users can chat freely with the AI, which acts as a fluent speaker of the target language. The app provides grammar correction, vocabulary tips, and cultural insights dynamically during the conversation. 💡
...
## 👥 Group 1 (Section 2) - Project P001
**Team Members & Contributions:**
1. 👩‍💻 **Mymuna Rahman** (ID: 2210465) – API Logic implementation and integration.
2. 🎨 **Tamanna Mannan** (ID: 2010294) – UI/UX design and frontend development.
3. 🔥 **Jubair Islam Labib** (ID: 2221134) – Firebase setup, database operations, and data persistence.
